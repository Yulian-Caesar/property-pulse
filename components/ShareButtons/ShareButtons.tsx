...
const ShareButtons = ({ property }: { property: PropertyCardType }) => {
	...
	return (
		<>
			...
			<div className="flex gap-3 justify-center pb-5">
				...
				<EmailShareButton url={shareUrl} subject={property.name} body={`Check out that property listing: ${shareUrl}`}>
